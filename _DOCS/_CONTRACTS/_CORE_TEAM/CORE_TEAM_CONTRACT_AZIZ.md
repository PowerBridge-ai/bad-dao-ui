# 📝 BAD DAO CORE TEAM MEMBER CONTRACT
...
The Core Team Member shall be responsible for **Operations & Governance Leadership** within BAD DAO, which includes but is not limited to:
...
1. **Governance Framework Development**: Lead the design and implementation of BAD DAO's governance structures
2. **Operations Management**: Oversee day-to-day operations of the DAO
3. **Proposal Process Oversight**: Manage the proposal submission, review, and implementation processes
4. **Cross-Team Coordination**: Facilitate communication and collaboration between different teams
5. **Community Management**: Develop strategies for community engagement and management

### Governance Participation

1. Serve as a required signer for all major proposal categories as specified in the BAD DAO Voting Guide
...
**Aziz**: _________________________ Date: __________
